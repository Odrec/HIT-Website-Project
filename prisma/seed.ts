...
const { Institution, EventType, UserRole, Affiliation } = $Enums
  ...
  const events = await Promise.all([
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.VORTRAG, institution: Institution.UNI,
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.RUNDGANG, institution: Institution.UNI,
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.WORKSHOP, institution: Institution.UNI,
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.LABORFUEHRUNG, institution: Institution.UNI,
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.LABORFUEHRUNG, institution: Institution.HOCHSCHULE,
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.VORTRAG, institution: Institution.HOCHSCHULE,
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.WORKSHOP, institution: Institution.HOCHSCHULE,
        timeStart: new Date(`${D}T14:00:00`), timeEnd: new Date(`${D}T15:30:00`),
    ...
    prisma.event.create({
      data: {
        ...
        infoMarkets: { create: [{ market: { connect: { id: infoMarkets[2].id } } }] },
      },
    }),
    prisma.event.create({
      data: {
        ...
        timeStart: new Date(`${D}T09:00:00`), timeEnd: new Date(`${D}T16:00:00`),
        infoMarkets: { create: [{ market: { connect: { id: infoMarkets[0].id } } }] },
      },
    }),
    prisma.event.create({
      data: {
    ...
    prisma.event.create({
      data: {
        ...
        eventType: EventType.RUNDGANG, institution: Institution.HOCHSCHULE,
