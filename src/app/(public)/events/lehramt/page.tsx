...
export default function LehramtEventsPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-hit-gray-600">
          Veranstaltungen rund um das Lehramt — von Universität und Hochschule.
        </p>
      </div>
      <EventListView staticFilters={{ lehramtCombined: 'true' }} />
    </div>
  )
}
